  ...
  return (
    <DashboardLayout>
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">Your personal financial advisor, powered by Gemini.</p>
      </div>

      <div className="bg-card rounded-2xl border border-border shadow-sm flex flex-col h-[600px]">
